...
Converts the ZIP to coordinates using the free Zippopotam API
...
What: Add an interactive map using Leaflet.js that shows a pin for each hospital result. Clicking a sidebar card should pan the map to that hospital.
...
DatasetSourceKey fields usedHospital Locationsdata.boston.govNAME, AD (address), NEIGH, LOCATION (lat/lng)Climate Vulnerabilitydata.boston.govName, POP100_RE, OlderAdult, TotChild, Low_to_No, TotDis, LEP
...
Uses Leaflet.js for maps and OpenStreetMap tiles.
